...
<head>
    ...
    <title>Form Mahasiswa POST 2</title>
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <form class="space-y-4 md:space-y-6" action="" method="post">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="harry@example.com" value="<?php if (isset($email)) {
                                                                                                                                                                                                                                                                                                                                                                                                        echo $email;} ?>">
                            <?php
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                rows="4" 
                                name="alamat"
                                placeholder="Privet Drive No. 4, Little Whinging" 
                        ...
                        <div>
                            ...
                            <div class="flex items-center mb-4">
                                <input id="pria" type="radio" name="jenis_kelamin" value="Pria" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" <?php if (isset($jenis_kelamin) && $jenis_kelamin == 'Pria')
                                                                                                                                                                                                                                                            echo "checked"; ?>>
                            ...
                            <div class="flex items-center mb-4">
                                <input id="wanita" type="radio" name="jenis_kelamin" value="Wanita" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" <?php if (isset($jenis_kelamin) && $jenis_kelamin == 'Wanita')
                                                                                                                                                                                                                                                                echo "checked"; ?>>
                        ...
                        <div>
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                name="minat[]" 
                                value="Coding" 
                                class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" <?php if (isset($minat) && in_array('Coding', $minat))
                                                                                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                                                                                        ?>>
                                <label for="coding" class="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                    Coding
                                </label>
                            </div>
                            <div class="flex items-center mb-4">
                                <input id="ux_design" type="checkbox" name="minat[]" value="UX Design" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" <?php if (isset($minat) && in_array('UX Design', $minat))
                                                                                                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                                                                                                ?>>
                                <label for="ux_design" class="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                    UX Design
                                </label>
                            </div>
                            <div class="flex items-center mb-4">
                                <input id="data_science" type="checkbox" name="minat[]" value="Data Science" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" <?php if (isset($minat) && in_array('Data Science', $minat))
                                                                                                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                                                                                                    ?>>
                                <label for="data_science" class="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                    Data Science
                                </label>
                            </div>
                            <?php
